                            ...
                            <div class="row g-2">
                                <div class="col-lg-8">
                                    <div class="card p-4 h-100">
                                        ...
                                        <div class="form-group mb-0" id="type-category" style="display: {{$banner['category_id']!=null?'block':'none'}}">
                                        ...
                                        <div class="form-group mb-0" id="type-plan" style="display: {{isset($banner['plan_id'])&&$banner['plan_id']!=null?'block':'none'}}">
