...
class CustomerLogic{
    ...
    public static function create_wallet_transaction(string|int $user_id, float $amount, string $transaction_type, ?string $referance): WalletTransaction|bool
    {
    ...
    public static function create_loyalty_point_transaction(string|int $user_id, ?string $referance, float $amount, ?string $transaction_type): bool
    {
    ...
    public static function referral_earning_wallet_transaction(string|int $user_id, ?string $transaction_type, ?string $referance, float $referralEarningAmount): bool
    {
    ...
    public static function loyalty_point_wallet_transfer_transaction(int|string $user_id, float $point, float $amount): void
    {
    ...
    public static function add_to_wallet(int|string $customer_id, float $amount): bool
    {
    ...
    public static function add_to_wallet_bonus(int|string $customer_id, float $amount): float|int
    {
