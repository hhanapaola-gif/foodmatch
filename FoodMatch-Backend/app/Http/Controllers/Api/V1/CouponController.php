...
class CouponController extends Controller
{
    ...
    public function list(Request $request): JsonResponse
    {
        ...
        if ($isGuest && !(integer)(Helpers::get_business_settings('guest_checkout') ?? 0)) {
    ...
    public function apply(Request $request): JsonResponse
    {
        ...
        if (!auth('api')->check() && !(integer)(Helpers::get_business_settings('guest_checkout') ?? 0)) {
            return response()->json([
                'errors' => [
                    ['code' => 'coupon', 'message' => translate('Guest checkout is disabled. You cannot apply coupons.')]
                ]
            ], 401);
        }
