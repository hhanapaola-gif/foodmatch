...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/admin')}}/css/upload-file_custom.css">
    @stack('css_or_js')
...
<!-- JS Implementing Plugins (after jQuery) -->
@stack('script')
...
<script src="{{asset('assets/admin/js/file-size-type-validation.js')}}"></script>
<script src="{{asset('assets/admin/js/upload-file_custom.js')}}"></script>
