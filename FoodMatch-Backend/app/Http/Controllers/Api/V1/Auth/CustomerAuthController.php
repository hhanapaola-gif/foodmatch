    ...
    public function login(Request $request): JsonResponse
    {
        ...
        if (isset($user)) {
            ...
            if (auth()->attempt($data)) {
                ...
                \Log::info('LOGIN TOKEN START');
                try {
                    $token = auth()->user()->createToken('RestaurantCustomerAuth')->accessToken;
                } catch (\Exception $e) {
                    return response()->json(['errors' => [['code' => 'token-error', 'message' => 'Authentication service unavailable. Please try again later.']]], 500);
                }
        ...
        return response()->json(['errors' => $errors], 401);
            ...
            return response()->json([
                'errors' => [['code' => 'login-error', 'message' => $e->getMessage()]]
            ], 500);
        }
    }
