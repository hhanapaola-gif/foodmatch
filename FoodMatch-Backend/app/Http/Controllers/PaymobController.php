...
class PaymobController extends Controller
{
    ...
    public function credit(Request $request): JsonResponse|RedirectResponse
    {
        ...
        $data = [
            ...
            'billing_data' => [
                "apartment" => "N/A",
                "email" => trim($payer->email ?? '') == '' ? "test@gmail.com" : $payer->email,
                "floor" => "N/A",
                "first_name" => trim($payer->name ?? '') == '' ? "abc name" : $payer->name,
                "street" => "N/A",
                "building" => "N/A",
                "phone_number" => trim($payer->phone ?? '') == '' ? "0182780000000" : $payer->phone,
                "shipping_method" => "PKG",
                "postal_code" => "N/A",
                "city" => "N/A",
                "country" => "N/A",
                "last_name" => trim($payer->name ?? '') == '' ? "abc name" : $payer->name,
                "state" => "N/A",
            ],
