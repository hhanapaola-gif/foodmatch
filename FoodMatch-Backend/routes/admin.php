...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('orders', fn() => redirect()->route('admin.plan-order.list'));
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            ...
            Route::group(['prefix' => 'restaurant', 'as' => 'restaurant.'], function () {
                Route::get('restaurant-setup', [BusinessSettingsController::class, 'companySettings'])->name('restaurant-setup')->middleware('actch');
                Route::post('update-setup', [BusinessSettingsController::class, 'companySettingsUpdate'])->name('update-setup')->middleware('actch');
                Route::get('restaurant-setup-legacy', [BusinessSettingsController::class, 'restaurantIndex'])->name('restaurant-setup-legacy')->middleware('actch');
                Route::post('update-setup-legacy', [BusinessSettingsController::class, 'restaurantSetup'])->name('update-setup-legacy')->middleware('actch');
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report_and_analytics_management']], function () {
            ...
            Route::get('export-plan-report', [ReportController::class, 'exportPlanReport'])->name('export-plan-report');
        });
        ...
        Route::group(['prefix' => 'plan-category', 'as' => 'plan-category.'], function () {
            Route::get('/',                         [PlanCategoryController::class, 'index'])->name('index');
            Route::post('store',                    [PlanCategoryController::class, 'store'])->name('store');
            Route::get('edit/{id}',                 [PlanCategoryController::class, 'edit'])->name('edit');
            Route::post('update/{id}',              [PlanCategoryController::class, 'update'])->name('update');
            Route::get('status/{id}/{status}',      [PlanCategoryController::class, 'status'])->name('status');
            Route::delete('delete',                 [PlanCategoryController::class, 'delete'])->name('delete');
        });
        // END PLAN CATEGORY MANAGEMENT
        ...
        Route::group(['prefix' => 'plan', 'as' => 'plan.'], function () {
            ...
            Route::get('status/{id}/{status}',    [PlanController::class, 'status'])->name('status');
            Route::delete('delete',               [PlanController::class, 'delete'])->name('delete');
        });
        // END PLAN MANAGEMENT

        // PLAN ORDERS
        Route::group(['prefix' => 'plan-order', 'as' => 'plan-order.'], function () {
            Route::get('list',              [PlanOrderController::class, 'index'])->name('list');
            Route::get('show/{id}',         [PlanOrderController::class, 'show'])->name('show');
            Route::post('status/{id}',      [PlanOrderController::class, 'updateStatus'])->name('status');
        });
        // END PLAN ORDERS
