            ...
            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="type" class="custom-select js-select2-custom" required>
                                            ...
                                            <option value="weekly"  {{ old('type') == 'weekly'  ? 'selected' : '' }}>{{ translate('Weekly') }}</option>
                                            <option value="monthly" {{ old('type') == 'monthly' ? 'selected' : '' }}>{{ translate('Monthly') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="restaurant_id" class="custom-select js-select2-custom">
                                            ...
                                            @foreach($branches as $branch)
                                                <option value="{{ $branch->id }}" {{ old('restaurant_id') == $branch->id ? 'selected' : '' }}>
                                                    {{ $branch->name }}
                                                </option>
                                            @endforeach
                                        </select>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            @php
                                ...
                                $oldServiceDays = old('service_days', []);
                            @endphp
                                ...
                                @foreach($dayAbbrs as $abbr)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               id="day-{{ $abbr }}"
                                               {{ in_array($abbr, $oldServiceDays) ? 'checked' : '' }}>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <label class="input-label">{{ translate('Upload PDF') }}</label>
                                <div class="input-group">
                                    <input type="file" name="menu_pdf" class="form-control"
                                           accept=".pdf" id="menu_pdf_input">
                                </div>
