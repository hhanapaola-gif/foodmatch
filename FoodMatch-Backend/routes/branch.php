...
use App\Http\Controllers\Branch\PlanController;
use App\Http\Controllers\Branch\PlanOrderController;
...
Route::group(['namespace' => 'Branch', 'as' => 'branch.', 'middleware' => 'maintenance_mode'], function () {
    ...
    Route::group(['middleware' => ['branch', 'branch_status']], function () {
        ...
        Route::group(['prefix' => 'plan', 'as' => 'plan.'], function () {
            ...
            Route::get('menu/{id}', [PlanController::class, 'menu'])->name('menu');
            Route::post('menu/{id}', [PlanController::class, 'menuUpdate'])->name('menu-update');
        });
