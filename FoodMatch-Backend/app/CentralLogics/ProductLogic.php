...
class ProductLogic
{
    ...
    public static function get_latest_products($limit, $offset, $product_type, $name, $category_ids, $sort_by, $is_halal): array
    {
    ...
    public static function get_wishlished_products($limit, $offset, $request): array
    {
    ...
    public static function get_popular_products($limit, $offset, $product_type, $name, $is_halal): array
    {
    ...
    public static function search_products($name, $rating, $category_id, $cuisine_id, $product_type, $sort_by, $limit, $offset, $min_price, $max_price, $is_halal): array
    {
        $limit = is_null($limit) ? 10 : $limit;
        $offset = is_null($offset) ? 1 : $offset;
    ...
    public static function get_recommended_products($limit, $offset, $name): array
    {
        $limit = is_null($limit) ? null : $limit;
        $offset = is_null($offset) ? 1 : $offset;
        $key = explode(' ', $name);
    ...
    public static function get_frequently_bought_products($limit, $offset): array
    {
        $limit = is_null($limit) ? 10 : $limit;
        $offset = is_null($offset) ? 1 : $offset;
