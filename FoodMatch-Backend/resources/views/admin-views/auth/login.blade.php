            ...
            <div class="auth-wrapper-form">
                    <form class="" id="form-id" action="{{route('admin.auth.login')}}" method="post">
                        ...
                        <div class="auth-header">
                            <div class="mb-5">
                                ...
                                <p class="mb-0">¿Quieres iniciar sesión como restaurante?
                                    <a href="{{route('branch.auth.login')}}">Iniciar sesión de restaurante</a>
                                </p>
                                <span class="badge mt-2">( Inicio de sesión de admin o empleado )</span>
                            </div>
                        </div>
                ...
                @if(env('APP_MODE')=='demo')
                    <div class="border-top border-primary pt-5 mt-10">
                        <div class="row">
                            <div class="col-10">
                                <span>Correo: admin@admin.com</span><br>
...
@if(env('APP_MODE')=='demo')
    <script>
        ...
        function copy_cred() {
            ...
            toastr.success('Copiado correctamente', 'Éxito', {
                CloseButton: true,
                ProgressBar: true
            });
        }
