                                            ...
                                            <div class="text-center">
                                                <div class="upload-file_custom ratio-3-1 h-100px mx-auto">
                                                    ...
                                                    <label class="upload-file__wrapper w-100 h-100 m-0">
                                                        ...
                                                        <img class="upload-file-img" loading="lazy" src="{{isset($data) && $data['logo'] ? asset('storage/email_template/'.$data['logo']) : asset('assets/admin/img/icons/upload_img2.png')}}"
                                            ...
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="465" id="viewer"
                                                         src="{{isset($data) && $data['logo'] ? asset('storage/email_template/'.$data['logo']) : asset('assets/admin/img/icons/upload_img2.png')}}"
